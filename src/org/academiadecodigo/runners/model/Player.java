...
public class Player implements KeyboardHandler {
    ...
    public Player() {
        ...
        this.pic = new Picture(435, 740, "src/resources/player_stop resized.png");
        this.picr = new Picture(435, 740, "src/resources/player_right resized.png");
        this.picl = new Picture(435, 740, "src/resources/player_left resized.png");
        this.pic.draw();
        this.limit = 0;
        this.lives = 6;
        this.init();

        this.end = new Picture(10, 10, "src/resources/gameover.jpeg");
        this.heart = new Picture(1010, 10, "src/resources/lifes.png");
        this.heart2 = new Picture(1010, 110, "src/resources/lifes.png");
        this.heart3 = new Picture(1010, 210, "src/resources/lifes.png");
        this.half = new Picture(1010, 10, "src/resources/half_heart.png");
        this.half2 = new Picture(1010, 110, "src/resources/half_heart.png");
        this.half3 = new Picture(1010, 210, "src/resources/half_heart.png");
